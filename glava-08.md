...
| operator | yes, no | В соответствии с лучшими практиками вы должны разрешить своим абонентам переключаться на оператора в любой момент записи голосового сообщения. Обратите внимание, что для обработки этих вызовов контексте exitcontext, требуется расширение o \(не \«ноль\», а буква \«о\»\). |
