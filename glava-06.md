...
Контексты определяются в файле _extensions.conf_, имя контекста заключается в квадратные скобки \(\[ \]\). Имя может состоять из букв A - Z \(верхний и нижний регистр\), чисел от 0 до 9, а также дефиса и подчеркивания.\[^1\] Контекст для входящих вызовов от оператора связи может быть назван так:
...
Этот стиль синтаксиса диалплана устарел. Новый синтаксис похож, но упрощен.
